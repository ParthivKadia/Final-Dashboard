  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="fixed left-2 right-2 top-[130px]
          sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:w-[361px]
          mt-0 sm:mt-[17px]
          z-[99999] flex h-[480px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
