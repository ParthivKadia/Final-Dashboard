...
import { PackageOpen, ChartSpline, CircleDollarSign, StickyNoteIcon } from "lucide-react";
...
export default function SalesAnalytics() {
  return (
    <AnalyticsDashboardPage
      ...
      stats={[
        { label: "Total Sales", value: "₹8.42L", subtext: "+18.4% from last month", color: "#2563eb", bg: "#eff6ff", icon: <CircleDollarSign className="w-4 h-4" /> },
        { label: "Orders", value: "1,284", subtext: "+96 new orders", color: "#16a34a", bg: "#f0fdf4", icon: <PackageOpen className="w-4 h-4" /> },
        { label: "Avg Order Value", value: "₹1,860", subtext: "Per completed order", color: "#d97706", bg: "#fffbeb", icon: <StickyNoteIcon className="w-4 h-4" /> },
        { label: "Conversion", value: "4.8%", subtext: "Store visit to order", color: "#9333ea", bg: "#faf5ff", icon: <ChartSpline className="w-4 h-4" /> },
      ]}
