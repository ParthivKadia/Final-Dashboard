...
import { getUrgency, LOW_STOCK_MAX, PAGE_SIZE, resolveCategory, Urgency } from "@/features/products/pages/LowStock";
              ...
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  {item.imageUrl ? (
                    ...
                    <Package className="w-5 h-5 text-base shrink-0 text-muted-foreground" aria-hidden="true" />
                  )}
