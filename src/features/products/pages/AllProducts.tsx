...
import { createProduct, deleteProduct, updateProduct } from "@/shared/services/productService";
...
import type { Product, CreateProductRequestBody, UpdateProductRequestBody, Store } from "@/shared/types/store";
import { PackageOpen, StoreIcon } from "lucide-react";
...
import { getCloudinaryUrl } from "@/shared/utils/cloudinaryUrlDisplay";
                        ...
                        <div className="site-thumb site-thumb-md flex-shrink-0">
                          {p.imageUrl
                            ? <img src={getCloudinaryUrl(p.imageUrl, 100)} alt={p.name} className="w-full h-full object-cover"
                                onError={e => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                            : <PackageOpen className="site-empty-icon w-12 h-12 opacity-60" aria-hidden="true" />
                          }
                        </div>
