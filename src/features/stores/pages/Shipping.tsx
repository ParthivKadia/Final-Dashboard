...
import { Handshake, Truck, Check, PackageOpen } from "lucide-react"
...
export default function Shipping() {
  return (
    <StorePage
      ...
      stats={[
        { label: "Avg Delivery Time", value: "3.2 days", subtext: "Across all orders", color: "#2563eb", bg: "#eff6ff", icon: <Truck className="w-4 h-4" /> },
        { label: "On-Time Rate", value: "94%", subtext: "Delivered within SLA", color: "#16a34a", bg: "#f0fdf4", icon: <Check className="w-4 h-4" /> },
        { label: "Pending Shipments", value: "18", subtext: "Awaiting dispatch", color: "#d97706", bg: "#fffbeb", icon: <PackageOpen className="w-4 h-4" /> },
        { label: "Courier Partners", value: "4", subtext: "Integrated carriers", color: "#9333ea", bg: "#faf5ff", icon: <Handshake className="w-4 h-4" /> },
      ]}
