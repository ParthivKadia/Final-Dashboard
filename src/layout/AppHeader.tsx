  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        {/* ── Top bar (mobile: logo + hamburger + dots) ── */}
        <div
        ...
        >
          {/* Sidebar toggle */}
          <button
            className="items-center justify-center w-10 h-10 rounded-lg border lg:flex lg:h-11 lg:w-11 transition-colors"
            style={{
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg lg:hidden transition-colors"
            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border py-2.5 pl-12 pr-14 text-sm shadow-theme-xs focus:outline-hidden focus:ring-3 xl:w-[430px] transition-colors"
                  style={{
                    backgroundColor: "rgba(255,255,255,0.06)",
                    borderColor: "rgba(255,255,255,0.12)",
                    color: "var(--navbar-text)",
                    "--tw-ring-color": "rgba(33,80,212,0.2)",
                  } as React.CSSProperties}
                  onFocus={(e) => {
                    e.currentTarget.style.borderColor = "var(--site-blue-400, #4076ea)";
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-5 py-4 lg:flex lg:justify-end lg:px-0 lg:shadow-none border-t lg:border-t-0`}
          style={{
            borderColor: "rgba(255,255,255,0.08)",
            backgroundColor: "var(--navbar-bg)",
          }}
