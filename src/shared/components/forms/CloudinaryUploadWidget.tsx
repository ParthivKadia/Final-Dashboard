...
import { prefetchCloudinarySignature, uploadImageToCloudinary } from '@/shared/utils/cloudinaryUpload';
    ...
    <div className="inline-flex flex-col gap-1">
      ...
      >
        {loading
          ...
          : <span className="flex items-center gap-2"><Upload className="w-4 h-4" aria-hidden="true" /> Upload Image</span>
        }
      </button>
      {error && (
        <p className="text-[11px] text-red-500 dark:text-red-400 flex items-center gap-1">
          ...
          <button type="button" onClick={() => setError(null)}
            className="ml-0.5 text-red-400 hover:text-red-600 text-sm leading-none">
